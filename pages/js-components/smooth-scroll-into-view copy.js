...
document.addEventListener("DOMContentLoaded", function () {
	...
	goToProductsButton.addEventListener("click", function (event) {
		...
		var targetSectionSelector = goToProductsButton.getAttribute("data-target"); //(use href if its the pointer)
		...
		var manualOffset = 80; // Adjust this value as needed. the higher the value, the further away from screen top
