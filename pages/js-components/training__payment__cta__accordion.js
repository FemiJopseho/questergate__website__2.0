// *For the "BEGINNER ONE-on-ONE" training-payment CTA on the Training webpage

// Wait for the DOM to be fully loaded before executing the code
document.addEventListener("DOMContentLoaded", function () {
	// Select all elements with the class "training__one-on-one__cta__button"
	const accordionButtons = document.querySelectorAll(
		".training__beginner__one-on-one__cta__button"
	);
...
// ////////////////////////////
// ////////////////////////////
// *For the "DEMO ONE-on-ONE" training-payment CTA on the Training webpage

// Wait for the DOM to be fully loaded before executing the code
document.addEventListener("DOMContentLoaded", function () {
	// Select all elements with the class "training__one-on-one__cta__button"
	const accordionButtons = document.querySelectorAll(
		".training__demo__one-on-one__cta__button"
	);
...
// ////////////////////////////
// ////////////////////////////
// *For the "live ONE-on-ONE" training-payment CTA on the Training webpage

// Wait for the DOM to be fully loaded before executing the code
document.addEventListener("DOMContentLoaded", function () {
	// Select all elements with the class "training__one-on-one__cta__button"
	const accordionButtons = document.querySelectorAll(
		".training__live__one-on-one__cta__button"
	);
...
// ////////////////////////////
// ////////////////////////////
// *For the "BEGINNER GROUP" training-payment CTA on the Training webpage

// Wait for the DOM to be fully loaded before executing the code
document.addEventListener("DOMContentLoaded", function () {
	// Select all elements with the class "training__group__cta__button"
	const accordionButtons = document.querySelectorAll(
		".training__beginner__group__cta__button"
	);
